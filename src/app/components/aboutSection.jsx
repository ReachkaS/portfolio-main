        ...
        content: (
            <ul className="education-list">
                <li className="education-item">
                    <div className="degree">Jin Fu Mao : ASA Coffee&Bakery and ASA 430 2nd Branch/ JUMBO Seafood Cambodia and FlaminGo hotpot</div>
                    ...
                    <div className="institution">- Managing of all Pages of the company</div>
                ...
                <li className="education-item">
                    ...
                    <div className="institution">Work Full Staff as Interior Design and Architecture</div>
                </li>
                <li className="education-item">
                    <div className="degree">Kolabot.kh/ Mean chhey</div>
                    <div className="date">01 March 2022 - 30 May 2022</div>
                    <div className="institution">Internship as an Architect and Interior Design</div>
                    
                </li>
                <li className="education-item">
                    <div className="degree">Thmor Architecture</div>
                    <div className="date">8 August 2021 - 8 November 2021</div>
                    <div className="institution">Internship as an Architect and Interior DesignKhmer</div>
                </li>
            </ul>
        ),
        images: [
    ...
    },
    {
        ...
        content: (
            <ul className="education-list">
                ...
                <li className="education-item">
                    <div className="institution">Hun Sen Borey 100 knorng High School</div>
...
const Certification = [
    <Image key="certifications-image1" src="/images/IMG_0543.png" alt="Certification image 1" width={200} height={300} />,
    <Image key="certifications-image2" src="/images/IMG_1403.png" alt="Certification image 2" width={200} height={300} />,
    <Image key="certifications-image3" src="/images/IMG_1443.png" alt="Certification image 2" width={200} height={300} />,
    <Image key="certifications-image4" src="/images/IMG_3755.JPG" alt="Certification image 2" width={200} height={300} />,
]
